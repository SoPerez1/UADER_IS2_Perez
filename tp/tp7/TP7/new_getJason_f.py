#implementacion inciso e: caratula
"""
...
def proveedor_de_datos(archivo: str, clave: str, usar_nueva_version: bool = True) -> str:
    ...
    Permite convivir con la versión vieja (procedural) and la nueva (Singleton)
...
#implementacion inciso f: control estricto de argumentos de ejecucion
    if len(argv) < 2:
...
#implementacion incisos c y f: control de errores usando la capa abstracta (Branching by Abstraction)
    try:
